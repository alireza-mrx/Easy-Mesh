...
v1
```
bash <(curl -Ls --ipv4 https://github.com/alireza-mrx/easy-mesh/raw/main/easymesh.sh)
```

v2
```
bash <(curl -Ls --ipv4 https://github.com/alireza-mrx/easy-mesh/raw/main/easymesh_v2.sh)
```
## My Telegram channel
